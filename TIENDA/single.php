		...
		<div class="inner-sec-shop pt-lg-4 pt-3">
			<div class="row">
				...
				<div class="col-lg-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">$.<?php echo $data_producto['precio_venta']; ?></span>
						<!-- <del>$1,199</del> -->
					</p>
					...
					echo '<button type="submit" onclick="agregar_producto(' . $data_producto['id_producto'] . ',' . $data_producto['stock'] . ')" class="googles-cart pgoogles-cart">';
