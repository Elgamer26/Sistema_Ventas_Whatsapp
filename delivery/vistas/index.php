...
<head>
    ...
    <link rel="icon" href="../../ADMIN/img/deivery.png">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link">
                            ...
                            <span></span><?php echo $_SESSION["nombre_re"]; ?>
                        </a>
                    </li>
                </ul>
            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong"><?php echo $_SESSION["nombre_re"] ?></div><small>Repartidor</small>
                    </div>
                </div>
                <ul class="side-menu metismenu">

                    <li>
                        <a style="color: white;" style="color: white;" onclick="cargar_contenido('contenido_principal','datos_personal.php');"><i class="sidebar-item-icon fa fa-user"></i>
                            <span class="nav-label">Datos personales </span>
                        </a>
                    </li>
                    <li>
                        <a style="color: white;" style="color: white;" onclick="cargar_contenido('contenido_principal','envios.php');"><i class="sidebar-item-icon fa fa-truck"></i>
                            <span class="nav-label">Envios </span>
                        </a>
                    </li>
                    <li>
                        <a style="color: white;" style="color: white;" onclick="cargar_contenido('contenido_principal','efe_espera.php');"><i class="sidebar-item-icon fa fa-minus-circle"></i>
                            <span class="nav-label">Efectivos en espera </span>
                        </a>
                    </li>
                    <li>
                        <a style="color: white;" style="color: white;" onclick="cargar_contenido('contenido_principal','efec_procesado.php');"><i class="sidebar-item-icon fa fa-check"></i>
                            <span class="nav-label">Efectivos procesados </span>
                        </a>
                    </li>

                    <li>
                        <a style="color: white; background: red;" style="color: white;" href="cerrar.php"><i class="sidebar-item-icon fa fa-circle-o"></i>
