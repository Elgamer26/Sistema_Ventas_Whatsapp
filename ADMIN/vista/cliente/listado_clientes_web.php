...
<section class="content-header">
    <h3>
        <b> Listado de clientes web <i class="fa fa-list"></i> </b>
    </h3>
</section>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-success">
                    <div class="ibox-head">
                        <div class="ibox-title">Lista de clientes web</div>
                    </div>
                    <div class="ibox-body">

                        <table id="tabla_clientes_web" class="display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
...
<div class="modal fade" id="modal_editar_cliente_web" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background: silver;">
                ...
                <button type="button" class="btn btn-primary" onclick="editar_clientes_web()"><i class="fa fa-edit"></i> Editar</button>
            </div>
        </div>
    </div>
</div>
