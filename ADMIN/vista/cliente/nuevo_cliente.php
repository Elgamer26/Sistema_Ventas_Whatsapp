                    ...
                    <div class="ibox-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <button onclick="cargar_contenido('contenido_principal','vista/cliente/nuevo_cliente.php');" class="btn btn-danger" type="button"><i class="fa fa-trash"></i> Limpiar</button>
                            </div>
                        </div>
