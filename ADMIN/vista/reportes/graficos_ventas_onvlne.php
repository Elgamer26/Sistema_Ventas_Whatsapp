...
<section class="content-header">
    <h3>
        <b> Gráficos ventas online <i class="fa fa-bar-chart"></i> </b>
    </h3>
</section>
<div class="content">
    <div class="col-md-13">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Gráficos ventas online</div>
                    </div>
                    <div class="ibox-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 form-group">
                                ...
                                <button onclick="ventas_online();" class="btn btn-info"><i class="fa fa-search"></i> Buscar</button>
                            </div>

                            <div class="col-sm-12 form-group">
                                <center>
                                    <div class="chart_o_v">
                                        <canvas id="char_o_ventas" style="height:200px;"></canvas>
                                    </div>
                                </center>
                            </div>
...
<script>
    ...
    function ventas_online() {
        ...
        $.ajax({
            ...
            if (response != 0) {
                ...
                mostrar_graficos_ventas_online(
                    fecha,
                    cantidad,
                    tipo_grafico,
                    nombre_grafico,
    ...
    function mostrar_graficos_ventas_online(
        fecha,
        cantidad,
        tipo_grafico,
        nombre_grafico,
        ...
        $("canvas#char_o_ventas").remove();
        $("div.chart_o_v").append(
            '<canvas id="char_o_ventas" style="height:200px;"></canvas>'
        );
        ///este es el grafico

        var ctx = document.getElementById("char_o_ventas").getContext("2d");
