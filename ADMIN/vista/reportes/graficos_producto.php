...
<section class="content-header">
    <h3>
        <b> Gráficos ventas productos <i class="fa fa-bar-chart"></i> </b>
    </h3>
</section>
<div class="content">
    <div class="col-md-13">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Gráficos ventas productos</div>
                    </div>
                    <div class="ibox-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 form-group">
                                ...
                                <button onclick="ventas_productos();" class="btn btn-info"><i class="fa fa-search"></i> Buscar</button>
                            </div>

                            <div class="col-sm-12 form-group">
                                <center>
                                    <div class="chart_v_p">
                                        <canvas id="char_v_producto" style="height:200px;"></canvas>
                                    </div>
                                </center>
                            </div>
...
<script>
    ...
    function ventas_productos() {
        ...
        $.ajax({
            ...
            if (response != 0) {
                ...
                mostrar_graficos_ventas_productos(
                    fecha,
                    cantidad,
                    tipo_grafico,
                    nombre_grafico,
    ...
    function mostrar_graficos_ventas_productos(
        fecha,
        cantidad,
        tipo_grafico,
        nombre_grafico,
        ...
        $("canvas#char_v_producto").remove();
        $("div.chart_v_p").append(
            '<canvas id="char_v_producto" style="height:200px;"></canvas>'
        );
        ///este es el grafico

        var ctx = document.getElementById("char_v_producto").getContext("2d");
