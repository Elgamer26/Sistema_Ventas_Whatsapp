        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Lista de envios</div> <a class="btn btn-danger" onclick="cargar_contenido('contenido_principal','vista/servicio_web/nuevo_envios.php');"><i class="fa fa-plus"></i> Nuevo envío</a>
                    </div>
                    <div class="ibox-body">

                        <table id="tabla_envioss" class="display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
