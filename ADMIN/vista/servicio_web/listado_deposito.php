...
<section class="content-header">
    <h3>
        <b> Listado efectivo <i class="fa fa-dollar"></i> </b>
    </h3>
</section>
        ...
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <div class="ibox ibox-primary">
                    <div class="ibox-head">
                        <div class="ibox-title">Lista efectivo</div>
                    </div>
                    <div class="ibox-body">

                        <table id="tabla_efectivo" class="display responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Pago</th>
