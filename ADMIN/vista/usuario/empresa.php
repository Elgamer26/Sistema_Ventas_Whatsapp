...
<script type="text/javascript" src="js/numero.min.js"></script>
                ...
                <div class="ibox ibox-primary">
                    ...
                    <div class="ibox-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                <label>Dirección</label> &nbsp;&nbsp; <label style="color:red;" id="dirccion_obliga"></label>
                            ...
                            <div class="col-sm-2 form-group">
                                <label>IVA: </label> &nbsp;&nbsp; <label style="color:red;" id="Iva_obliga"></label>
                                <input type="text" maxlength="2" class="form-control" id="IVA" placeholder="IVA" onkeypress="return soloNumeros(event)">
                            </div>

                            <div class="col-sm-12 form-group">
                                <label>Descripción</label> &nbsp;&nbsp; <label style="color:red;" id="descripcion_obliga"></label>
