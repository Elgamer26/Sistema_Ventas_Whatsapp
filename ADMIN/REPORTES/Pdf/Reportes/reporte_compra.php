...
$html = '<!DOCTYPE html>
    <html lang="en">
      ...
      <tr>
        ...
        <h1  style="color: black;"> Reporte compra </h1>
          ...
          <table>
            <thead>
              ...
              <th style="color: black; " class="desc"><b> Fecha </b></th>
                <th style="color: black; " class="desc"><b> Proveedor </b></th>             
                <th style="color: black; " class="desc"><b> N° compra </b></th>
...
$sqldetalle = 'SELECT
                ...
                WHERE
                compra.estado = 1 AND DATE(compra.fecha) BETWEEN "' . $f_i . '" AND "' . $f_f . '"';
