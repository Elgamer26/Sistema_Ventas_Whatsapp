    ...
    return (
      (c = (function () {
        ...
        return (
          (a.prototype.validate = function () {
            ...
            if (10 !== (s = this.numero.length) && 13 !== s)
              throw ((this.valid = !1), new Error("Longitud incorrecta."));
            if (
              ((h = 24),
              (this.codigo_provincia = parseInt(this.numero.substr(0, 2), 10)),
              this.codigo_provincia < 1 || this.codigo_provincia > h)
            )
              throw (
                ((this.valid = !1),
                new Error("Código de provincia incorrecto."))
              );
            if (((k = parseInt(this.numero[2], 10)), 7 === k || 8 === k))
            ...
            if (
              (9 === k
                ...
                : 6 > k && (this.tipo_de_cedula = "Persona natural"),
              (g = []),
              6 > k)
            )
              for (
                c = 10,
                  l = parseInt(this.numero.substr(9, 1), 10),
                  e = 2,
                  t = this.numero.substr(0, 9),
                  m = 0,
                  q = t.length;
                q > m;
                m++
            ...
            if (6 === k) {
              for (
                l = parseInt(this.numero.substr(8, 1), 10),
                  c = 11,
                  d = [3, 2, 7, 6, 5, 4, 3, 2],
                  b = n = 0;
                7 >= n;
                ...
                g[b] = parseInt(this.numero[b], 10) * d[b];
              g[8] = 0;
            }
            if (9 === k)
              for (
            ...
            if (((i = j % c), (a = 0 === i ? 0 : c - i), 6 === k)) {
              if ("0001" !== this.numero.substr(9, 4))
                throw new Error(
            ...
            if (9 === k) {
              if ("001" !== this.numero.substr(10, 3))
                throw new Error("RUC de entidad privada debe terminar en 001");
              this.valid = a === l;
            }
            if (6 > k) {
              if (
                this.numero.length > 10 &&
                "001" !== this.numero.substr(10, 3)
              )
      ...
      (d = (function () {
        function d(c, d) {
          (this.$node = c),
            (this.options = d),
            (this.validateContent = a(this.validateContent, this)),
            (this.options = b.extend(
              {},
              b.fn.validarCedulaEC.defaults,
              this.options
            )),
            this.$node.on(this.options.events, this.validateContent);
        }
        return (
          (d.prototype.validateContent = function () {
            var a, b, d, e;
            if (
              ((d = this.$node.val().toString()),
              (a = this.options.strict),
              a || (10 !== (e = d.length) && 13 !== e) || (a = !0),
              a)
            )
              try {
                new c(d).isValid()
      ...
      (b.fn.validarCedulaEC.RucValidatorEc = c),
      (b.fn.validarCedulaEC.defaults = {
        strict: !0,
        events: "change",
        the_classes: "invalid",
